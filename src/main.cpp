...
int main(void) {
    ...
    floor_transfo.setTranslation(glm::vec3(0.25f, -1.f, 0.25f));
    //floor_transfo.setScale(glm::vec3(10.f, 4.f, 50.f));
    floor_transfo.setScale(glm::vec3(0.5f, 0.5f, 0.5f));
    ...
    DynamicObject rigid_object = DynamicObject::bodyFromMesh(StaticBody(&object_mesh, &rigid_object_transformation), 0.05f, 0.1f);
    ...
    do {
        ...
        if (run_simulation) {
            ...
            rigid_object.updateRenderedConstraints();
        }
